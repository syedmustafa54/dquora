...
class CommentForm extends React.Component {
  ...
  render() {
    ...
    const buttonClass = isLoading ? 'CommentForm__button_disabled' : 'CommentForm__button_primaryss';
      ...
      <div className="CommentForm">
        ...
        <div className="CommentForm__text">
          ...
          >
            ...
            {isLoading ? (
              <FormattedMessage id="comment_send_progresss" defaultMessage="Commenting" />
            ) : (
              <FormattedMessage id="comment_sends" defaultMessage="Answer It" />
            )}
          </button>
          {bodyHTML && (
