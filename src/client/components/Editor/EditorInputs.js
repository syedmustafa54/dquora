...
class EditorInputs extends React.Component {
  static propTypes = {
  ...
  handleChange(e) {
    ...
    this.setValue("This Question Was Posted From DQuora \n Give Answers Or Ask Questions at http://www.dquora.com");
    window.alert(value);
  }
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className="EditorInput__dropzone-base" hidden  >
          <Dropzone
            disableClick
            style={{}}
            accept="image/*"
          ...
          >
            ...
            <HotKeys keyMap={this.constructor.hotkeys} handlers={this.handlers}>
              <Input.TextArea
                ...
                value={"This Post Was Posted From Dquora.com"+value }
                ref={this.setInput}
              />
            </HotKeys>
          </Dropzone>
        </div>
        <p className="EditorInput__imagebox" hidden >
          <input
            type="file"
